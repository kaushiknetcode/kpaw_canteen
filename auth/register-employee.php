...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_verify()) {
        ...
        if (!preg_match('/^[A-Z0-9]{6}$/', $hrms_id)) $errors[] = "HRMS ID must be exactly 6 letters/numbers.";
...
<form method="post" novalidate>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="hrms_id" class="form-control text-uppercase" maxlength="6" required
               value="<?= htmlspecialchars($_POST['hrms_id'] ?? '') ?>">
        <div class="form-text">Exactly 6 letters/numbers, e.g. AB1234</div>
    </div>
    <div class="mb-3">
